...
| WorkBuddy | 根 `AGENTS.md`/MCP 原生复用、仅 `.codebuddy/skills` 映射、`CODEBUDDY.md` 遮蔽诊断、configuration-only 同步、20 次幂等 | PASS |
...
- `uv run nox -s main`: PASS；180 项全量测试，总覆盖率 89.54%，核心覆盖率 91%。
